...
alias sta="git stash"
alias staName='git stash save -u'
alias staList='git stash save -u'
alias dif='git diff'
alias glog='git log'
alias reflog='git reflog'
alias reset='git reset hard'
alias pull='git pull origin'
alias cb='git pull origin'
alias ft='git fetch'
alias mg='git merge'
...
alias aws="open -a '/Applications/Google Chrome.app' https://aws.amazon.com/jp/"
...
alias poll="npm run watch-pcargo"
