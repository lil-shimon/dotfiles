...
-- Normal Mode
-- q to close
-- space f to open find in files *
-- space r to open live grep *
-- space t to open help tags
-- space a to resume *
-- space e to diagnostics
-- /// for open buffers
--
-- Insert Mode
-- space q to close *
...
-- Normal mode *
-- space space to open telescope file browser
-- q to close
-- N to create
...
vim.keymap.set('n', ' t', '<cmd>lua require("telescope.builtin").help_tags()<cr>',
  opts)
vim.keymap.set('n', ' a', '<cmd>lua require("telescope.builtin").resume()<cr>',
  opts)
